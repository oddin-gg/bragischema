...
func (m *MatchTimelineFeedMessage) GetPayload() isMatchTimelineFeedMessage_Payload {
	if m != nil {
		return m.Payload
	}
	return nil
...
func (x *MatchTimelineFeedMessage) GetKeepalive() *KeepAlive {
	if x, ok := x.GetPayload().(*MatchTimelineFeedMessage_Keepalive); ok {
		return x.Keepalive
	}
	return nil
}
...
func (x *MatchTimelineFeedMessage) GetTimeline() *MatchTimeline {
	if x, ok := x.GetPayload().(*MatchTimelineFeedMessage_Timeline); ok {
		return x.Timeline
	}
	return nil
}
...
func (x *MatchTimelineFeedMessage) GetMatchUpdate() *Match {
	if x, ok := x.GetPayload().(*MatchTimelineFeedMessage_MatchUpdate); ok {
...
var file_bragi_bragi_service_proto_rawDesc = []byte{
	...
	,
}
...
func file_bragi_bragi_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_bragi_bragi_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MatchTimelineFeedRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bragi_bragi_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MatchTimelineFeedMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bragi_bragi_service_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bragi_bragi_service_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
	...
	file_bragi_bragi_service_proto_msgTypes[8].OneofWrappers = []interface{}{
	...
	file_bragi_bragi_service_proto_msgTypes[9].OneofWrappers = []interface{}{
		(*MatchState_Cs2)(nil),
