...
func (c *bragiClient) MatchTimeline(ctx context.Context, in *MatchTimelineRequest, opts ...grpc.CallOption) (*MatchTimelineResponse, error) {
	...
	err := c.cc.Invoke(ctx, Bragi_MatchTimeline_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bragiClient) MatchTimelineFeed(ctx context.Context, in *MatchTimelineFeedRequest, opts ...grpc.CallOption) (Bragi_MatchTimelineFeedClient, error) {
	stream, err := c.cc.NewStream(ctx, &Bragi_ServiceDesc.Streams[0], Bragi_MatchTimelineFeed_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *bragiClient) LiveDataFeed(ctx context.Context, in *LiveDataFeedRequest, opts ...grpc.CallOption) (Bragi_LiveDataFeedClient, error) {
	stream, err := c.cc.NewStream(ctx, &Bragi_ServiceDesc.Streams[1], Bragi_LiveDataFeed_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
