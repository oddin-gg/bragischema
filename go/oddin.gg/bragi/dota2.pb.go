...
type Dota2MatchScoreboard struct {
	...
	HomeTeamUrn  string                `protobuf:"bytes,3,opt,name=home_team_urn,json=homeTeamUrn,proto3" json:"home_team_urn,omitempty"`
	AwayTeamUrn  string                `protobuf:"bytes,4,opt,name=away_team_urn,json=awayTeamUrn,proto3" json:"away_team_urn,omitempty"`
...
func (x *Dota2MatchScoreboard) GetHomeTeamUrn() string {
	if x != nil {
...
func (x *Dota2MatchScoreboard) GetAwayTeamUrn() string {
	if x != nil {
...
var file_bragi_dota2_proto_rawDesc = []byte{
	...
	0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x68, 0x6f, 0x6d, 0x65, 0x54, 0x65, 0x61,
	0x6d, 0x55, 0x72, 0x6e, 0x12, 0x22, 0x0a, 0x0d, 0x61, 0x77, 0x61, 0x79, 0x5f, 0x74, 0x65, 0x61,
	0x6d, 0x5f, 0x75, 0x72, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x61, 0x77, 0x61,
