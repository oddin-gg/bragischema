...
func (this *RushCricketCurrentInningStatePartialUpdate_TeamCurrentInningState) EqualVT(thatIface isRushCricketCurrentInningStatePartialUpdate_Update) bool {
	that, ok := thatIface.(*RushCricketCurrentInningStatePartialUpdate_TeamCurrentInningState)
	if !ok {
		return false
	}
	if this == that {
