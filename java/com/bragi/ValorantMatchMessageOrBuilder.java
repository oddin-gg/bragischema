...
public interface ValorantMatchMessageOrBuilder extends
    // @@protoc_insertion_point(interface_extends:bragi.ValorantMatchMessage)
   ...
   * @return The payload.
   */
  com.bragi.ValorantMatchMessage.Payload getPayload();
  /**
   * <code>.bragi.ValorantMatchMessage.Payload payload = 5 [json_name = "payload"];</code>
   */
  com.bragi.ValorantMatchMessage.PayloadOrBuilder getPayloadOrBuilder();
}
