...
export class RushCricketCurrentInningStatePartialUpdate extends jspb.Message {
  hasGameTime(): boolean;
  clearGameTime(): void;
  getGameTime(): RushCricketCurrentMapTimeState | undefined;
  setGameTime(value?: RushCricketCurrentMapTimeState): void;

  hasScore(): boolean;
  clearScore(): void;
  getScore(): RushCricketCurrentMapScoreState | undefined;
  setScore(value?: RushCricketCurrentMapScoreState): void;
...
export namespace RushCricketCurrentInningStatePartialUpdate {
  export type AsObject = {
    gameTime?: RushCricketCurrentMapTimeState.AsObject,
    score?: RushCricketCurrentMapScoreState.AsObject,
...
export class RushCricketCurrentMapState extends jspb.Message {
  getPeriod(): RushCricketPeriodMap[keyof RushCricketPeriodMap];
  setPeriod(value: RushCricketPeriodMap[keyof RushCricketPeriodMap]): void;
  ...
  getTeamsMap(): jspb.Map<string, RushCricketTeamCurrentMapState>;
  clearTeamsMap(): void;
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): RushCricketCurrentMapState.AsObject;
  static toObject(includeInstance: boolean, msg: RushCricketCurrentMapState): RushCricketCurrentMapState.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: RushCricketCurrentMapState, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): RushCricketCurrentMapState;
  static deserializeBinaryFromReader(message: RushCricketCurrentMapState, reader: jspb.BinaryReader): RushCricketCurrentMapState;
}

export namespace RushCricketCurrentMapState {
  export type AsObject = {
    period: RushCricketPeriodMap[keyof RushCricketPeriodMap],
    gameTime?: RushCricketCurrentMapTimeState.AsObject,
    score?: RushCricketCurrentMapScoreState.AsObject,
    mapPaused: boolean,
    teamsMap: Array<[string, RushCricketTeamCurrentMapState.AsObject]>,
  }
}

export class RushCricketCurrentMapTimeState extends jspb.Message {
  hasRealTime(): boolean;
  clearRealTime(): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): RushCricketCurrentMapTimeState.AsObject;
  static toObject(includeInstance: boolean, msg: RushCricketCurrentMapTimeState): RushCricketCurrentMapTimeState.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: RushCricketCurrentMapTimeState, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): RushCricketCurrentMapTimeState;
  static deserializeBinaryFromReader(message: RushCricketCurrentMapTimeState, reader: jspb.BinaryReader): RushCricketCurrentMapTimeState;
}

export namespace RushCricketCurrentMapTimeState {
  export type AsObject = {
...
export class RushCricketTeamCurrentMapState extends jspb.Message {
  getTeamUrn(): string;
  setTeamUrn(value: string): void;

  hasMapStatistics(): boolean;
  clearMapStatistics(): void;
  getMapStatistics(): RushCricketTeamCurrentMapStatisticsState | undefined;
  setMapStatistics(value?: RushCricketTeamCurrentMapStatisticsState): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): RushCricketTeamCurrentMapState.AsObject;
  static toObject(includeInstance: boolean, msg: RushCricketTeamCurrentMapState): RushCricketTeamCurrentMapState.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: RushCricketTeamCurrentMapState, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): RushCricketTeamCurrentMapState;
  static deserializeBinaryFromReader(message: RushCricketTeamCurrentMapState, reader: jspb.BinaryReader): RushCricketTeamCurrentMapState;
}

export namespace RushCricketTeamCurrentMapState {
  export type AsObject = {
    teamUrn: string,
    mapStatistics?: RushCricketTeamCurrentMapStatisticsState.AsObject,
...
export class RushCricketTeamCurrentMapStatisticsState extends jspb.Message {
  getRuns(): number;
  setRuns(value: number): void;
  ...
  getCurrentRunRate(): number;
  setCurrentRunRate(value: number): void;

  getRequiredRunRate(): number;
  setRequiredRunRate(value: number): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): RushCricketTeamCurrentMapStatisticsState.AsObject;
  static toObject(includeInstance: boolean, msg: RushCricketTeamCurrentMapStatisticsState): RushCricketTeamCurrentMapStatisticsState.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: RushCricketTeamCurrentMapStatisticsState, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): RushCricketTeamCurrentMapStatisticsState;
  static deserializeBinaryFromReader(message: RushCricketTeamCurrentMapStatisticsState, reader: jspb.BinaryReader): RushCricketTeamCurrentMapStatisticsState;
}

export namespace RushCricketTeamCurrentMapStatisticsState {
  export type AsObject = {
    runs: number,
    wickets: number,
